...
<div class="invoice p-3 mb-3">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <h4>
                <img width="50px" src="<?= base_url('assets/logo/logo1.png') ?>" alt="Go Store"><b> Go Store Shop</b>
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <img src="<?= base_url() ?>templates/dist/img/credit/visa.png" alt="Visa">
            <img src="<?= base_url() ?>templates/dist/img/credit/mastercard.png" alt="Mastercard">
            <img src="<?= base_url() ?>templates/dist/img/credit/american-express.png" alt="American Express">
            <img src="<?= base_url() ?>templates/dist/img/credit/paypal2.png" alt="Paypal">
    ...
    <div class="row no-print">
        <div class="col-3">
            <a href="<?= base_url('belanja') ?>" rel="noopener" class="btn btn-default">kembali</a>
            <button type="submit" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Proses
                Pembayaran
            </button>
        </div>
        <div class="col-7"></div>
        <div class="col-2">
            <img width="50px" src="<?= base_url('assets/logo/logo1.png') ?>" alt="Go Store" style="text-align:left"><b>
                Go
                Store Shop</b>
        </div>
    </div>

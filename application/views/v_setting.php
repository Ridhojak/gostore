<div class="container-fluid">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <textarea name="alamat_toko" class="form-control" rows="5" value="<?= $setting->alamat_toko ?>"
                placeholder="masukan alamat"><?= $setting->alamat_toko ?></textarea>
            <br>
            <div class="form-group">
        ...
        $("select[name='provinsi']").on("change", function () {
            ...
            $.ajax({
                ...
                success: function (hasil_kota) {
                    ...
                    $("select[name='lokasi']").html(hasil_kota);
                }

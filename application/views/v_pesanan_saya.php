        ...
        <div class="card card-primary card-outline card-outline-tabs">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill"
                            href="#custom-tabs-four-gagal" role="tab" aria-controls="custom-tabs-four-profile"
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-gagal" role="tabpanel"
                        aria-labelledby="custom-tabs-four-profile-tab">
                        <!-- bagian diproses-->
                        <table class="table">
                            <thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            Rp.
                                            <?= number_format($value->total_bayar, 0, ',', '.') ?>,<br>
                                            <span class="badge badge-danger">verifikasi Gagal</span><br>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php } ?>
